...
import com.github.shannieann.wyrmroost.entities.dragon.DragonFruitDrakeEntity;
...
public class DragonFruitDrakeModel extends DragonEntityModel<DragonFruitDrakeEntity>
{
    ...
    public WRModelPart LegfrontR1_1;
    ...
    public WRModelPart LegSegmentR1_1;
    public WRModelPart LegSegmentR2_1;
    public WRModelPart LegSegmentR3_1;
    public WRModelPart backfootR_1;
    ...
    public WRModelPart EyeR_1;
    public WRModelPart LegfrontR2;
    public WRModelPart LegfrontR3;
    public WRModelPart frontfootR;
    public WRModelPart LegfrontR2_1;
    public WRModelPart LegfrontR3_1;
    public WRModelPart frontfootR_1;

    public DragonFruitDrakeModel()
    {
        this.texWidth = 100;
        this.texHeight = 70;
        this.LegSegmentR1 = new WRModelPart(this, 57, 31);
        ...
        this.LegSegmentR2_1 = new WRModelPart(this, 55, 41);
        ...
        this.LegSegmentR1_1 = new WRModelPart(this, 57, 31);
        ...
        this.LegfrontR3_1 = new WRModelPart(this, 40, 39);
        ...
        this.LegfrontR1 = new WRModelPart(this, 34, 18);
        ...
        this.SideLeaf1R = new WRModelPart(this, 0, 29);
        ...
        this.SideLeaf2L = new WRModelPart(this, 0, 29);
        ...
        this.LegfrontR3 = new WRModelPart(this, 40, 39);
        ...
        this.Tail3 = new WRModelPart(this, 82, 24);
        ...
        this.frontfootR = new WRModelPart(this, 40, 46);
        ...
        this.Tail2 = new WRModelPart(this, 80, 13);
        ...
        this.EyeR_1 = new WRModelPart(this, 16, 0);
        ...
        this.BackLeafR_1 = new WRModelPart(this, 0, 23);
        ...
        this.frontfootR_1 = new WRModelPart(this, 40, 46);
        ...
        this.Tail1 = new WRModelPart(this, 80, 13);
        ...
        this.Tail5 = new WRModelPart(this, 86, 34);
        ...
        this.shape71_1 = new WRModelPart(this, 6, 26);
        ...
        this.LegfrontR2 = new WRModelPart(this, 34, 29);
        ...
        this.LegSegmentR3 = new WRModelPart(this, 61, 50);
        ...
        this.LegfrontR1_1 = new WRModelPart(this, 34, 18);
        ...
        this.BackLeaf1 = new WRModelPart(this, 0, 29);
        ...
        this.LegThighR_1 = new WRModelPart(this, 59, 18);
        ...
        this.BackLeafL_1 = new WRModelPart(this, 0, 23);
        ...
        this.Neck2Leaf = new WRModelPart(this, 5, 15);
        ...
        this.SideLeaf2R = new WRModelPart(this, 0, 29);
        ...
        this.LegSegmentR3_1 = new WRModelPart(this, 61, 50);
        ...
        this.Head = new WRModelPart(this, 0, 4);
        ...
        this.backfootR_1 = new WRModelPart(this, 61, 55);
        ...
        this.Tail6 = new WRModelPart(this, 86, 34);
        ...
        this.Tail4 = new WRModelPart(this, 82, 24);
        ...
        this.Tail7 = new WRModelPart(this, 88, 42);
        ...
        this.shape71 = new WRModelPart(this, 6, 26);
        ...
        this.neck4 = new WRModelPart(this, 23, 0);
        ...
        this.EyeR = new WRModelPart(this, 16, 0);
        ...
        this.TailLeaf4 = new WRModelPart(this, 0, 29);
        ...
        this.backfootR = new WRModelPart(this, 61, 55);
        ...
        this.NeckLeaf3 = new WRModelPart(this, 0, 14);
        ...
        this.SideLeaf1L = new WRModelPart(this, 0, 29);
        ...
        this.BackLeafL = new WRModelPart(this, 0, 23);
        ...
        this.Neck1Leaf = new WRModelPart(this, 10, 16);
        ...
        this.neck3 = new WRModelPart(this, 23, 0);
        ...
        this.TailLeaf3 = new WRModelPart(this, 0, 23);
        ...
        this.TailLeafEND = new WRModelPart(this, 82, 40);
