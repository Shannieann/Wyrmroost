...
public class SoundData implements DataProvider
{
    ...
    public void run(HashCache cache) throws IOException
    {
        ...
        DataProvider.save(GSON, cache, file, gen.getOutputFolder().resolve("assets/" + Wyrmroost.MOD_ID + "/sounds.json"));
    }
    ...
    {
        Preconditions.checkArgument(fileHelper.exists(resource, PackType.CLIENT_RESOURCES, ".ogg", "sounds"),
